...
Thank you for choosing ${global.config.BOTNAME}, enjoy yourselfs<3`, threadID);
	}
	else {
		try {
    const request = require("request");
...
memLength.sort((a, b) => a - b);
			...
			(typeof threadData.customJoin == "undefined") ? msg = "Assalamualaikum {uName}\nWelcome to {threadName}\n\nYou're the {soThanhVien}th member of this group, enjoy yourself!✨" : msg = threadData.customJoin;
			msg = msg
