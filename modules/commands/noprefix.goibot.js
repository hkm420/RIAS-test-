...
if(input2.includes("haha") || input2.includes("lmao") || input2.includes("lol") || input2.includes("😂") || input2.includes("😹") || input2.includes("🤣") || input2.includes("😆") || input2.includes("😄") || input2.includes("hq") || input2.includes("xd")){
					        	return api.setMessageReaction("😹", event.messageID, (err) => {}, true)
} 
    if(input2.includes("break up") || input2.includes("sad") || input2.includes("fuck") || input2.includes("bye") ||input2.includes("Fuck") || input2.includes("Bye") || input2.includes("Break up")){
					        	return api.setMessageReaction("😿", event.messageID, (err) => {}, true)
    }
