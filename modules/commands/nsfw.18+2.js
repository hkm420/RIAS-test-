module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Kirito",
  description: "Random girl pictures (NSFW (⁠◠⁠‿⁠・⁠)⁠",
...
const fs = global.nodemodule["fs-extra"];
  var link = [
   ...
   var callback = () => api.sendMessage({body:`Watch me🫦?\nphoto number ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
