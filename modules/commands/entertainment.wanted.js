...
module.exports.run = async ({ event, api, args, Users }) => {
  ...
  if (this.config.credits != 'Kirito') {
        console.log('\x1b[33m[ WARN ]\x1b[37m » Change credits to your mothers dick, bitch:))'+ global.config.BOTNAME + ' the credits modules "' + this.config.name + '"');
