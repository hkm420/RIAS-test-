module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Kirito",
    description: "Hug somone by mentioning them",
...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage("Please mention 1 person.", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "Currently I'm the happiest person on earth✨", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
      }
