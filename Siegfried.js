...
console.log(chalk.bold.hex("#03f0fc").bold("[ Kirito ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Kirito`, '[ Kirito ]');
        logger('Hey, thank you for using this Rias', '[ Kirito ]');
        logger("Fixed by Kirito", '[ Kirito ]');
        logger("FB: facebook.com/hrhabib.001", 'Fixed by Kirito');
      var cron = require("node-cron");
      //die thief of files potanginamo
